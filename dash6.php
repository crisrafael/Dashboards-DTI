...
$abertosTempodeVida = $consultas->abertosTempodeVida();
$abertosTempodeVidaGeral = $consultas->abertosTempodeVidaGeral();
            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                                    ...
                                    <div class="panel-heading">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-9 text-right">
                                                <div class="huge"><?php echo $abertosTempodeVidaGeral["Mesmo dia"]; ?></div>
                                                <div>Mesmo dia</div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="panel panel-grey">
                                    <div class="panel-heading">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-9 text-right">
                                                <div class="huge"><?php echo $abertosTempodeVidaGeral["1 dia"]; ?></div>
                                                <div>1 dia</div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="panel panel-green">
                                    <div class="panel-heading">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-9 text-right">
                                                <div class="huge"><?php echo $abertosTempodeVidaGeral["2-5 dias"]; ?></div>
                                                <div>2 à 5 dias</div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-3">
                                <div class="panel panel-yellowCustom">
                                    <div class="panel-heading">
                                        <div class="row">
                                            <div class="col-xs-3">
                                                <i class="fa fa-clock-o fa-5x"></i>
                                            ...
                                            <div class="col-xs-9 text-right">
                                                <div class="huge"><?php echo $abertosTempodeVidaGeral["6-10 dias"]; ?></div>
                                                <div>6 à 10 dias</div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-heading">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-9 text-right">
                                                <div class="huge"><?php echo $abertosTempodeVidaGeral["11-20 dias"]; ?></div>
                                                <div>11 à 20 dias</div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="panel panel-yellow">
                                    <div class="panel-heading">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-9 text-right">
                                                <div class="huge"><?php echo $abertosTempodeVidaGeral["21-30 dias"]; ?></div>
                                                <div>21 à 30 dias</div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="panel panel-red">
                                    <div class="panel-heading">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-9 text-right">
                                                <div class="huge"><?php echo $abertosTempodeVidaGeral["Mais de 30 dias"]; ?></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-heading"><b>CHAMADOS ABERTOS - TEMPO DE VIDA</b></div>
                            ...
                            data: [
                                {
                                    ...
                                    indexLabel: "{y}",
                                    color: "rgba(75, 157, 255, 0.3)",
                                    dataPoints: [<?php echo $abertosTempodeVida["Mesmo dia"]; ?>]
                                },
                                {
                                    type: "stackedBar100",
                                    showInLegend: true,
                                    ...
                                    dataPoints: [<?php echo $abertosTempodeVida["1 dia"]; ?>]
                                },
                                {
                                    type: "stackedBar100",
                                    showInLegend: true,
                                    ...
                                    dataPoints: [<?php echo $abertosTempodeVida["2-5 dias"]; ?>]
                                },                                
                                {
                                    type: "stackedBar100",
                                    showInLegend: true,
                                    ...
                                    indexLabelPlacement: "inside",
                                    indexLabel: "{y}",
                                    color: "rgba(182, 150, 44, 0.5)",
                                    dataPoints: [<?php echo $abertosTempodeVida["6-10 dias"]; ?>]
                                },
                                {
                                    type: "stackedBar100",
                                    showInLegend: true,
                                    ...
                                    indexLabelPlacement: "inside",
                                    indexLabel: "{y}",
                                    dataPoints: [<?php echo $abertosTempodeVida["11-20 dias"]; ?>]
                                },
                                {
                                    type: "stackedBar100",
                                    showInLegend: true,
                                    ...
                                    indexLabelPlacement: "inside",
                                    indexLabel: "{y}",
                                    color: "rgba(180, 57, 0, 0.4)",
                                    dataPoints: [<?php echo $abertosTempodeVida["21-30 dias"]; ?>]
                                },
                                {
                                    type: "stackedBar100",
                                    showInLegend: true,
                                    ...
                                    dataPoints: [<?php echo $abertosTempodeVida["Mais de 30 dias"]; ?>]
                                }
