...
$atendentesSD = $atendentes->retornaAtendentes(7);
$emAtendimentoOperadores = $consultas->emAtendimentoEquipes($atendentesSD["user_id"],7);
$encerradosOperadores = $consultas->encerradosAtendente($atendentesSD["user_id"],7);
